...
module.exports = {
	SESSION_ID: (process.env.SESSION_ID || "Session~HxGn96w8").trim(),
	BOT_INFO: process.env.BOT_NAME || "Astro;Bot",
	SUDO: process.env.SUDO || "923164413714",
	...
	STICKER_PACK: process.env.AUTHOR || "Noah",
